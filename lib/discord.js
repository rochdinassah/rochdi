...
Discord.prototype.onReady = function (data) {
  ...
  log(Object.keys(guilds[0]));

  log('auth ok | username: %s, userID: %s, email: %s', user.username, user.id, user.email);
...
Discord.prototype.getGuildByNameId = function (nameId) {
  ...
  guilds[0].channels = void 0;
  guilds[0].users = void 0;
  guilds[0].members = void 0;
  guilds[0].roles = void 0;
  return guilds[0];
};