...
String.prototype.padLeft = function (padding, maxLength) {
  if (this.startsWith(padding) || maxLength <= this.length)
    return this;
  ...
  return (padding+this).substr(0, maxLength);
};

String.prototype.padRight = function (padding, maxLength) {
  if (this.endsWith(padding) || maxLength <= this.length)
    return this;
  ...
  return (this+padding).substr(0, maxLength);
};
