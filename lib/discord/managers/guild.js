...
class GuildManager extends EventEmitter {
  constructor(manager) {
    ...
    const { logger, connection_manager, request_manager } = manager;
  ...
  deleteChannel(channel_id) {
    ...
    return request_manager.delete('channels/'+channel_id).then(res => {
      const { status_code, data } = res;
