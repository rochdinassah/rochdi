...
class GuildManager extends EventEmitter {
  constructor(manager) {
    ...
    connection_manager.on('GUILD_CREATE', this.onGuildCreate.bind(this));
    connection_manager.on('CHANNEL_CREATE', this.onChannelCreate.bind(this));
    connection_manager.on('CHANNEL_UPDATE', this.onChannelUpdate.bind(this));
    connection_manager.on('CHANNEL_DELETE', this.onChannelDelete.bind(this));
    connection_manager.on('MESSAGE_CREATE', this.onMessageCreate.bind(this));
  }
