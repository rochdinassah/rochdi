...
Http2Client.prototype.ensueSession = function (authority, opts = {}) {
  ...
  if (!session || session.closed || session.destroyed || cipher !== session.cipher) {
    session = http2.connect(authority)
      .on('error', this.onsessionerror.bind(this))
      .on('close', this.onsessionclose.bind(this))
      .on('connect', this.onsessionconnect.bind(this));
...
Http2Client.prototype.onsessionerror = function (err) {};
Http2Client.prototype.onsessionclose = function () {};
Http2Client.prototype.onsessionconnect = function () {};
