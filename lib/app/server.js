...
Server.prototype.onExit = function (cb) {
  exit_callbacks.push(cb.bind(this));
};
...
Server.prototype.run = function () {
  return new Promise(resolve => {
    ...
    http_server.on('request', onRequest.bind(this)).listen(port, '::0', resolve);
...
Server.prototype.acq = function () {
  return this.state_manager.acq();
};
